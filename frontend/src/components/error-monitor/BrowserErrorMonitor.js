...
import { Error as ErrorIcon, Warning as WarningIcon, CheckCircle as CheckCircleIcon, PlayArrow as PlayIcon, Stop as StopIcon, Refresh as RefreshIcon, BugReport as BugReportIcon, Build as BuildIcon, Visibility as VisibilityIcon, Assessment as AssessmentIcon, Security as SecurityIcon, NetworkCheck as NetworkCheckIcon, Code as CodeIcon } from '@mui/icons-material';
// MCP Playwright サービス
...
const BrowserErrorMonitor = ({ targetUrl = 'http://192.168.3.135:3000', autoStart = false, onErrorDetected, onErrorFixed, onInfiniteLoopStarted, onInfiniteLoopStopped }) => {
    ...
    const getErrorTypeIcon = (type) => {
        switch (type) {
            case 'console': return _jsx(CodeIcon, {});
            case 'network': return _jsx(NetworkCheckIcon, {});
            case 'javascript': return _jsx(BugReportIcon, {});
            case 'security': return _jsx(SecurityIcon, {});
            case 'accessibility': return _jsx(VisibilityIcon, {});
            default: return _jsx(ErrorIcon, {});
        }
    };
    // 初期化とクリーンアップ
    useEffect(() => {
