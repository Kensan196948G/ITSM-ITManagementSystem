...
async def delete_user(
    ...
    return SuccessResponse(
        message="ユーザーが正常に削除されました", data={"user_id": user_id}
    )
...
async def activate_user(
    ...
    return SuccessResponse(
        message="ユーザーが正常にアクティベートされました", data={"user_id": user_id}
    )
...
async def deactivate_user(
    ...
    return SuccessResponse(
        message="ユーザーが正常に無効化されました", data={"user_id": user_id}
    )
