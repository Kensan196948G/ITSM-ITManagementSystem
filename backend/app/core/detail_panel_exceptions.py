...
class EntityNotFoundError(DetailPanelException):
    ...
    def __init__(
        self, entity_type: str, entity_id: UUID, user_id: Optional[UUID] = None
    ):
...
class InsufficientPermissionError(DetailPanelException):
    ...
    def __init__(
        self, user_id: UUID, entity_type: str, entity_id: UUID, required_permission: str
    ):
...
class RateLimitExceededError(DetailPanelException):
    ...
    def __init__(self, user_id: UUID, endpoint: str, limit: int, reset_time: datetime):
...
class CacheError(DetailPanelException):
    ...
    def __init__(
        self, message: str, cache_operation: str, cache_key: Optional[str] = None
    ):
        super().__init__(
            message=message,
            error_code="CACHE_ERROR",
            details={"cache_operation": cache_operation, "cache_key": cache_key},
        )
...
class DetailPanelErrorHandler:
    ...
    def handle_exception(
        self, request: Request, exc: Exception, trace_id: Optional[str] = None
    ) -> JSONResponse:
        """例外をHTTPレスポンスに変換"""
    ...
    def _handle_detail_panel_exception(
        self, exc: DetailPanelException, trace_id: Optional[str] = None
    ) -> JSONResponse:
        """詳細パネル例外の処理"""
    ...
    def _handle_http_exception(
        self, exc: HTTPException, trace_id: Optional[str] = None
    ) -> JSONResponse:
        """HTTPException の処理"""
    ...
    def _handle_generic_exception(
        self, exc: Exception, trace_id: Optional[str] = None
    ) -> JSONResponse:
        """一般例外の処理"""
...
class PerformanceMonitor:
    ...
    def check_query_performance(
        self, query_name: str, execution_time: float, user_id: Optional[UUID] = None
    ):
        """クエリパフォーマンスチェック"""
    ...
    def check_memory_usage(
        self, operation_name: str, memory_usage: int, user_id: Optional[UUID] = None
    ):
        """メモリ使用量チェック"""
