...
class TestBasicUI:
    ...
    def test_incident_creation_form(self, test_config):
        ...
        with patch('playwright.sync_api.Page') as mock_page:
            ...
            page.fill('[data-testid="incident-description"]', "Test incident description")
    ...
    def test_accessibility_features(self, test_config):
        ...
        with patch('playwright.sync_api.Page') as mock_page:
            ...
            aria_label = page.get_attribute('[data-testid="create-incident-btn"]', 'aria-label')
    ...
    def test_error_handling(self, test_config):
        ...
        with patch('playwright.sync_api.Page') as mock_page:
            ...
            page.goto(f"{test_config.get('web_url', 'http://localhost:3000')}/incidents")
