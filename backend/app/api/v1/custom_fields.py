...
async def list_custom_field_definitions(
    entity_type: Optional[str] = Query(None, description="エンティティタイプ（incident, user, problem等）"),
...
@router.post(
    ...
    responses={
        ...
        403: {"model": APIError, "description": "カスタムフィールド作成権限がありません"},
        500: {"model": APIError, "description": "サーバーエラーが発生しました"}
    }
)
...
@router.get(
    ...
    responses={
        ...
        404: {"model": APIError, "description": "指定されたカスタムフィールド定義が見つかりません"},
        500: {"model": APIError, "description": "サーバーエラーが発生しました"}
    }
)
...
@router.put(
    ...
    responses={
        ...
        400: {"model": APIError, "description": "リクエストデータが不正です"},
        404: {"model": APIError, "description": "指定されたカスタムフィールド定義が見つかりません"},
        403: {"model": APIError, "description": "カスタムフィールド更新権限がありません"},
        500: {"model": APIError, "description": "サーバーエラーが発生しました"}
    }
)
...
@router.delete(
    ...
    responses={
        ...
        404: {"model": APIError, "description": "指定されたカスタムフィールド定義が見つかりません"},
        403: {"model": APIError, "description": "カスタムフィールド削除権限がありません"},
        500: {"model": APIError, "description": "サーバーエラーが発生しました"}
    }
)
...
@router.get(
    ...
    responses={
        ...
        404: {"model": APIError, "description": "指定されたエンティティが見つかりません"},
        500: {"model": APIError, "description": "サーバーエラーが発生しました"}
    }
)
