...
class ContinuousBackendMonitor:
    ...
    async def _repair_single_error(
    ...
    async def _repair_connection_error(
        self, error: Dict[str, Any]
    ) -> Optional[Dict[str, Any]]:
        """接続エラー修復"""
        return {
    ...
    async def _repair_process_error(
        self, error: Dict[str, Any]
    ) -> Optional[Dict[str, Any]]:
        """プロセスエラー修復"""
        return {
    ...
    async def _save_errors(self, errors: List[Dict[str, Any]]):
        ...
        try:
            ...
            errors_data = {
                "backend_errors": [
                    e for e in errors if e["type"] in ["api_error", "connection_error"]
                ],
