...
class TestIncidentModel:
    ...
    def test_incident_title_validation(self):
        ...
        # Invalid titles
        invalid_titles = ["", "a" * 256, None]  # Empty  # Too long  # None
    ...
    def test_incident_description_validation(self):
        ...
        invalid_descriptions = ["", "A" * 10000, None]  # Empty  # Too long  # None
...
class TestUserModel:
    ...
    def test_username_validation(self):
        ...
        # Valid usernames
        valid_usernames = ["john_doe", "admin123", "user.name", "support-team"]
    ...
    def test_full_name_validation(self):
        ...
        # Valid names
        valid_names = ["John Doe", "Mary Jane Smith", "Jean-Pierre O'Connor", "李 小明"]
