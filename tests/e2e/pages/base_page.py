...
class BasePage(ABC):
    ...
    def close_modal(self, modal_id: str):
        ...
        self.page.wait_for_selector(
            f'[data-testid="modal-{modal_id}"]', state="detached"
        )
    ...
    def get_table_cell_text(self, table_selector: str, row: int, column: int) -> str:
        ...
        cell = (
            self.page.locator(f"{table_selector} tbody tr")
            .nth(row)
            .locator("td")
            .nth(column)
        )
    ...
    def search_in_table(
        self, search_input_selector: str, search_term: str, table_selector: str
    ):
