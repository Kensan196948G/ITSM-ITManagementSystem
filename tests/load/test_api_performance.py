...
class TestAPIPerformance:
    ...
    def test_single_incident_creation_performance(
        self, test_config, api_headers, sample_incident_data, benchmark
    ):
    ...
    def test_incident_list_query_performance(self, test_config, api_headers, benchmark):
        ...
        def query_incidents():
            mock_response = {
                "data": [
                    {"id": f"INC{i:06d}", "title": f"Test incident {i}"}
                    for i in range(20)
                ],
    ...
    def test_concurrent_incident_creation(
        self, test_config, api_headers, sample_incident_data
    ):
        ...
        with ThreadPoolExecutor(max_workers=concurrent_requests) as executor:
            futures = [
                executor.submit(create_incident_with_id, i)
    ...
    def test_large_dataset_pagination_performance(
        self, test_config, api_headers, benchmark
    ):
    ...
    def test_complex_query_performance(self, test_config, api_headers, benchmark):
        ...
        def execute_complex_query():
            mock_response = {
                "data": [
                    {"id": "INC000123", "priority": "high", "status": "in_progress"}
                ],
                "meta": {"total_count": 1},
            }
    ...
    def test_bulk_operations_performance(self, test_config, api_headers, benchmark):
        ...
        def bulk_update_incidents():
            ...
            mock_response = {
                ...
                "failed_count": 0,
                "results": [
                    {"id": f"INC{i:06d}", "status": "success"} for i in range(100)
                ],
            }
    ...
    def test_api_response_time_vs_payload_size(
        self, test_config, api_headers, payload_size, benchmark
    ):
