...
class SystemTester:
        ...
        try:
            ...
            self.test_results.append({
                ...
                "details": {
                    ...
                    "total_endpoints": getattr(health_metrics, 'total_endpoints', 0),
        ...
        try:
            ...
            async with httpx.AsyncClient(timeout=30.0) as client:
                ...
                response = await client.post(
                    f"{self.base_url}/api/v1/error-repair/detect-errors",
                    json=test_data
                )
                ...
                if response.status_code == 200:
                    ...
                    details.update({
                        ...
                        "error_categories": response_data.get("error_categories", {}),
                        "has_recommendations": bool(response_data.get("recommendations", []))
                    })
    ...
    async def test_manual_repair(self):
        ...
        try:
            ...
            async with httpx.AsyncClient(timeout=30.0) as client:
                response = await client.post(
                    f"{self.base_url}/api/v1/error-repair/manual-repair",
                    json=test_data
                )
    ...
    async def test_system_integration(self):
        ...
        try:
            ...
            passed = all(dir_tests) and any(config_tests) and monitor_works and controller_works
